...
public class PDFExtractionWithBookmark {
    private static String output = "";
    private static String maxLenStr = "";

    public PDFExtractionWithBookmark(String fileName) throws IOException {
        PDFExtraction(fileName);
    }

    private void PDFExtraction (String fileName) throws IOException {
